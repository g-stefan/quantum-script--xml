...
#	define XYO_QUANTUMSCRIPT_EXTENSION_XML_EXPORT XYO_PLATFORM_LIBRARY_EXPORT
#else
#	define XYO_QUANTUMSCRIPT_EXTENSION_XML_EXPORT XYO_PLATFORM_LIBRARY_IMPORT
#endif
#ifdef XYO_QUANTUMSCRIPT_EXTENSION_XML_LIBRARY
#	undef XYO_QUANTUMSCRIPT_EXTENSION_XML_EXPORT
#	define XYO_QUANTUMSCRIPT_EXTENSION_XML_EXPORT
#endif
